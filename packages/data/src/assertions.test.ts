import { assertJoinGameErrorPayloadPacket, assertJoinGameRequestPayloadPacket } from './assertions'
import { PayloadType } from './enums'
import { JoinGameErrorPayloadPacket, JoinGameRequestPayloadPacket } from './types'

const joinGameRequest: JoinGameErrorPayloadPacket | JoinGameRequestPayloadPacket = {
  type: PayloadType.JoinGame,
  code: -1
}

const joinGameError: JoinGameErrorPayloadPacket | JoinGameRequestPayloadPacket = {
  type: PayloadType.JoinGame,
...
test('assertJoinGameErrorPayloadPacket', () => {
  ...
  expect(() => assertJoinGameRequestPayloadPacket(joinGameRequest)).not.toThrow()
